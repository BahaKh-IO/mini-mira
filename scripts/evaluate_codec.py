...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--codec-checkpoint", required=True, help="Trained checkpoint to evaluate")
...
def _autocast(precision: str) -> torch.autocast:
    # Same convention as train_codec.py's own _autocast -- bf16 needs no GradScaler-equivalent
